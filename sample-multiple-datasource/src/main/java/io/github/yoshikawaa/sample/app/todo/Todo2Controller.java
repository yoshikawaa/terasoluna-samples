...
import io.github.yoshikawaa.sample.app.todo.TodoForm.TodoCreate;
import io.github.yoshikawaa.sample.app.todo.TodoForm.TodoDelete;
import io.github.yoshikawaa.sample.app.todo.TodoForm.TodoFinish;
import io.github.yoshikawaa.sample.domain.model.Todo;
import io.github.yoshikawaa.sample.domain.service.todo.ITodoService;

@Controller
@RequestMapping("todo2")
public class Todo2Controller extends TodoController {
